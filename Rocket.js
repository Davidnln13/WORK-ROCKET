class Rocket
{
  ...
  {
    //when were in the middle of the screen start moving sidewards
    //when we move fully out move back in until were centered
  ...
  moveUp()
  {
    ...
    //if the rocket is destroyed move down off the screen
